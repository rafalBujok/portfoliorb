...
export class Slide3Component implements OnInit {
  ...
  project = [
    ...
    ['Generator postaci do Warhammera', 'Strona ze sporą biblioteką dotyczącą gry fabularnej Warhammer, za pomocą strony można tworzyć karty postaci, edytować je i zapisywać w bazie danych Firebase', 'https://mojagraaa.web.app/bohater', 'https://github.com/Grolmorth/warhammer-char-gen-2-ed', 'assets/warhammer.jpg'],
